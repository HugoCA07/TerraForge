...
Physics & Collisions: Optimized AABB collision detection and spatial partitioning (Quadtrees) for smooth performance.

Dynamic Day/Night Cycle: Ambient lighting system implemented via SFML shaders.
...
UI/Debugging: Dear ImGui (optional/integration)
